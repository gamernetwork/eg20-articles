var InlineGallery = Class.create({
	...
	{	
		...
		{
			this.frame.update('<iframe frameborder="0" framepadding="0" framespacing="0" scrolling="no" width="300" height="250" src="https://web.archive.org/web/20130607075522/http://ads.eurogamer.net/delivery/afr.php?zoneid='+this.adzone+'" class="advert" style="display: none;">&nbsp;</iframe>');
		}
		else
		{		
...
document.observe(
	...
	function()
	{
		...
		{
			image = "https://web.archive.org/web/20130607075522/http://images.eurogamer.net/" + e.target.getAttribute("data-uri");
