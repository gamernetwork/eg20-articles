var InlineGallery = Class.create({
	...
	{	
		...
		{
			this.frame.update('<iframe frameborder="0" framepadding="0" framespacing="0" scrolling="no" width="300" height="250" src="https://web.archive.org/web/20140421082600/http://ads.eurogamer.net/delivery/afr.php?zoneid='+this.adzone+'" class="advert" style="display: none;">&nbsp;</iframe>');
		}
		else
		{		
...
document.observe(
	...
	function()
	{
		...
		{
			image = "https://cdn.gamer-network.net/" + e.target.getAttribute("data-uri");
...
/*
     FILE ARCHIVED ON 08:26:00 Apr 21, 2014 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 16:06:50 Aug 29, 2019.
...
playback timings (ms):
  ...
  captures_list: 243.708
  exclusion.robots.policy: 0.128
  load_resource: 132.935
  PetaboxLoader3.resolve: 199.742 (3)
  LoadShardBlock: 224.721 (3)
  RedisCDXSource: 0.439
  CDXLines.iter: 15.446 (3)
  PetaboxLoader3.datanode: 119.687 (5)
*/